...
export default class ChatContainer extends Component {
  ...
  addUserToChat = ({ chatId, newUser }) => {
    ...
    const newChats = chats.map(chat => {
      if (chat.id === chatId) {
        return {
          users: Object.assign({}, chat, { users: [...chat.users, newUser] }),
          visibleFor: Object.assign({}, chat, {
            canSeeMessages: [...chat.canSeeMessages, newUser.id]
          })
        };
      }
      return chat;
    });
    this.setState({ chats: newChats.users });
  };
